...
export const navConfig: NavItem[] = [
    ...
    },
    {
        ...
        path: '/city-services',
        icon: 'MapPin',
        description: 'Manage city boundaries and special locations',
        children: [
            {
                label: 'City Boundaries',
                path: '/city-services/geometries',
                icon: 'Map',
                resource: 'DSL',
                action: 'RIDER_MANAGEMENT/MERCHANT/GET_MERCHANT_CONFIG_GEOMETRY_LIST',
                allowedModules: ['BAP', 'BPP'],
                showLocked: true,
                description: 'Manage city and region boundaries',
            },
            {
                label: 'Special Locations',
                path: '/city-services/special-locations',
                icon: 'MapPin',
                resource: 'DSL',
                action: 'RIDER_MANAGEMENT/MERCHANT/GET_MERCHANT_CONFIG_SPECIAL_LOCATION_LIST',
                allowedModules: ['BAP', 'BPP'],
                showLocked: true,
                description: 'Manage airports, stations, and key areas',
            },
        ],
    },
    {
